...
object Constants {
    ...
    val BURNING_START_TILE_TWO = Tile(3178, 3497, 0)

    val AREA_BURNING = Area(Tile(3146, 3497, 0), Tile(3178, 3496, 0))
    ...
    val BURNING_START_PATH_TWO = TilePath(arrayOf(Tile(3162, 3490, 0), Tile(3162, 3491, 0),
        Tile(3162, 3492, 0), Tile(3163, 3492, 0), Tile(3164, 3492, 0),
        Tile(3165, 3493, 0), Tile(3166, 3493, 0), Tile(3167, 3494, 0),
        Tile(3168, 3494, 0), Tile(3169, 3495, 0), Tile(3170, 3495, 0),
        Tile(3171, 3496, 0), Tile(3172, 3496, 0), Tile(3173, 3496, 0),
        Tile(3174, 3496, 0), Tile(3175, 3497, 0), Tile(3176, 3497, 0),
        Tile(3177, 3497, 0), BURNING_START_TILE_TWO))
}